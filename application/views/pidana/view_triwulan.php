    				...
    				foreach ($tampil as $data) {
    				 echo '
    				  <tr>
    					...
    					<td><center>'.$data->tmas1.'</center></td>
    					<td><center>'.$data->tput1.'</center></td>
    					<td><center>'.$data->tisa1.'</center></td>
    				  </tr>
    				  <tr>
    					<td><center>II</center></td>
    					<td><center>'.$data->tmas2.'</center></td>
    					<td><center>'.$data->tput2.'</center></td>
    					<td><center>'.$data->tisa2.'</center></td>
    				  </tr>
    				  <tr>
    					<td><center>III</center></td>
    					<td><center>'.$data->tmas3.'</center></td>
    					<td><center>'.$data->tput3.'</center></td>
    					<td><center>'.$data->tisa3.'</center></td>
    				  </tr>
    				  <tr>
    					<td><center>IV</center></td>
    					<td><center>'.$data->tmas4.'</center></td>
    					<td><center>'.$data->tput4.'</center></td>
    					<td><center>'.$data->tisa4.'</center></td>
    				  </tr>';
    				}
