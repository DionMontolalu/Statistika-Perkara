    				...
    				foreach ($tampil as $data) {
    				 echo '
    				  <tr>
    					...
    					<td><center>'.$data->smas1.'</center></td>
    					<td><center>'.$data->sput1.'</center></td>
    					<td><center>'.$data->sisa1.'</center></td>
    				  </tr>
    				  <tr>
    					<td><center>II</center></td>
    					<td><center>'.$data->smas2.'</center></td>
    					<td><center>'.$data->sput2.'</center></td>
    					<td><center>'.$data->sisa2.'</center></td>
    				  </tr>';
    				}
