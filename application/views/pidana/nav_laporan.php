		...
		<br><br>
		 <div class="login-panel panel panel-warning">
		  ...
		  <div class="panel-body">
		   <div class="row">
		    <div class="col-md-6">
		  	<a href="laporan/bulanan"><span class="btn btn-default btn-block" title="Lihat Pemeriksaan"><h4><i class="fa fa-calendar"></i> BULANAN</h4></span></a>
		  	</div>
		  	<div class="col-md-6">
		   ...
		   <div class="row">
		  	...
		  	<div class="col-md-6">
		  		<a href="laporan/grafik"><span class="btn btn-default btn-block" title="Lihat Pemeriksaan"><h4><i class="fa fa-bar-chart"></i> GRAFIK PERKARA PIDANA</h4></span></a>
		  	</div>
		   	</div>
