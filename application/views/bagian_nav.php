		...
		<br><br>
		 <div class="login-panel panel panel-default">
		  <div class="panel-heading">
		  	<h3 class="panel-title"><center><b>Bagian Divisi</b></center></h3>
		  </div> <!-- Divisi panel heading -->
		  <div class="panel-body">
		  	<a href="perdata/laporan"><span class="btn btn-success btn-block" title="Lihat Pemeriksaan"><h3><i class="fa fa-institution"></i> PERDATA</h3></span></a>
		  	<br>
		  	<a href="pidana/laporan"><span class="btn btn-warning btn-block" title="Lihat Pemeriksaan"><h3><i class="fa fa-institution"></i> PIDANA</h3></span></a>
		  	<br><br>
		  	<a href="<?php echo base_url(); ?>index.php/login/logout"><span class="btn btn-danger btn-block" title="Lihat Pemeriksaan"><h3><i class="fa fa-sign-out"></i> LogOut</h3></span></a>
		  </div>		
		 </div>
		</div>
		<div class="col-md-3">&nbsp</div>	
